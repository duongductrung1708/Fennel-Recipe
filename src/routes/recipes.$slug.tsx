...
const DIETARY_META: Record<DietaryTag, DietaryMeta> = {
  Vegetarian: {
    icon: Leaf,
    description: "Suitable for vegetarians — contains no meat, poultry, or seafood.",
    kind: "info",
  },
  Vegan: {
    icon: Sprout,
  ...
  "Gluten-Free": {
    icon: WheatOff,
    description: "Made without gluten-containing grains such as wheat, barley, or rye.",
    kind: "info",
  },
  "Dairy-Free": {
    icon: MilkOff,
    description: "Made without milk, cheese, butter, or other dairy ingredients.",
    kind: "info",
  },
  Pescatarian: {
    icon: Fish,
  ...
  Spicy: {
    icon: Flame,
    description: "Noticeably spicy — includes chilies or other hot ingredients.",
    kind: "info",
  },
  "Contains Nuts": {
    icon: Nut,
  ...
  "Contains Shellfish": {
    icon: Shell,
    description: "Allergen warning: contains shellfish such as shrimp, crab, or lobster.",
    kind: "warn",
  },
  "Contains Pork": {
    icon: Drumstick,
    ...
    <article>
      <div className="mx-auto max-w-6xl px-6 pt-10">
        ...
        <div className="grid gap-8 md:grid-cols-[1.4fr_1fr] md:items-end">
          <div>
            <p className="text-primary uppercase tracking-[0.3em] text-xs mb-3">{recipe.cuisine}</p>
            <h1 className="font-display text-5xl md:text-6xl lg:text-7xl leading-[0.95]">
              {recipe.title}
            </h1>
            <p className="mt-4 text-muted-foreground text-lg max-w-xl">{recipe.tagline}</p>
              ...
              <TooltipProvider delayDuration={150}>
                ...
                >
                  {recipe.dietary.map((tag) => {
                    ...
                    const statusLabel = isWarning ? "Allergen warning" : "Dietary suitability";
                    return (
                          ...
                          <TooltipTrigger asChild>
                            ...
                            >
                              <StatusIcon
                                ...
                                aria-hidden="true"
                              />
                              <Icon className="h-4 w-4 shrink-0 sm:h-3 sm:w-3" aria-hidden="true" />
